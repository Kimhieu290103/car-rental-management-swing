	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource() == rentCarView.btnAddNewCustomer) {
			...
			if (customerRepository.seclectById(newCustomer) != null) {
				...
				JOptionPane.showMessageDialog(rentCarView, "Khách hàng này không tồn tại!", "CẢNH BÁO",
						JOptionPane.WARNING_MESSAGE);
			}
		} else if (e.getSource() == rentCarView.btnOK) {
			if (rentCarView.txtCCCD.getText().isEmpty() || rentCarView.txtCustomerName.getText().isEmpty()
					|| rentCarView.txtCustomerPhone.getText().isEmpty()) {
				JOptionPane.showMessageDialog(rentCarView, "BẠN PHẢI ĐIỀN ĐỦ THÔNG TIN KHÁCH HÀNG!", "CẢNH BÁO",
						JOptionPane.WARNING_MESSAGE);
			} else {
				Customer newCustomer = new Customer();
				newCustomer.setCar_id(rentCarView.txtCCCD.getText());
				...
				if (customerRepository.seclectById(newCustomer) == null) {
					...
					JOptionPane.showMessageDialog(rentCarView, "Khách hàng mới đã được thêm thành công!", "THÔNG BÁO",
							JOptionPane.INFORMATION_MESSAGE);
				} else {
					JOptionPane.showMessageDialog(rentCarView, "Khách hàng đã tồn tại!", "CẢNH BÁO",
							JOptionPane.WARNING_MESSAGE);
				}
			}
			...
			if (rentCarView.txtDateStart.getText().isEmpty() || rentCarView.txtDateEnd.getText().isEmpty()
					|| customerRepository.seclectById(customer) == null) {
				JOptionPane.showMessageDialog(rentCarView, "BẠN PHẢI ĐIỀN ĐỦ THÔNG TIN!", "CẢNH BÁO",
						JOptionPane.WARNING_MESSAGE);
			} else {
				try {
					...
					JOptionPane.showMessageDialog(rentCarView, ex.getMessage(), "LỖI", JOptionPane.ERROR_MESSAGE);
				}
			}
		}
	}
