...
public class AddNewCarView extends JFrame {
	...
	private void init() {
		...
		JLabel lbTitle = new JLabel("THÊM XE MỚI");
	...
	public void setDefaultInfromation() {
		txt1.setText("");
		txt2.setText("");
		txt3.setText("");
		txt4.setText("");
	...
	public static AddNewCarView getInstance() {
		return new AddNewCarView();
	}
}
